...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "computations1/computations.pyx"
        ]
    },
    "module_name": "computations1.computations"
}
END: Cython Metadata */
...
#define __PYX_HAVE__computations1__computations
#define __PYX_HAVE_API__computations1__computations
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'computations1.computations' */
...
static void __pyx_f_13computations1_12computations_matrixMultiply(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "computations1.computations"
extern int __pyx_module_is_main_computations1__computations;
int __pyx_module_is_main_computations1__computations = 0;

/* Implementation of 'computations1.computations' */
...
static PyObject *__pyx_pf_13computations1_12computations_matrixMultiply(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_matrix1, __Pyx_memviewslice __pyx_v_matrix2, __Pyx_memviewslice __pyx_v_matrix_result, int __pyx_v_N); /* proto */
...
/* "computations1/computations.pyx":7
...
static PyObject *__pyx_pw_13computations1_12computations_1matrixMultiply(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static void __pyx_f_13computations1_12computations_matrixMultiply(__Pyx_memviewslice __pyx_v_matrix1, __Pyx_memviewslice __pyx_v_matrix2, __Pyx_memviewslice __pyx_v_matrix_result, int __pyx_v_N, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_idx_ij;
  int __pyx_v_idx_ik;
  int __pyx_v_idx_kj;
  ...
  /* "computations1/computations.pyx":13
 *     int N
 * ):
 *     cdef int idx_ij = 0             # <<<<<<<<<<<<<<
 *     cdef int idx_ik = 0
 ...
 */
  ...
  /* "computations1/computations.pyx":14
 * ):
 *     cdef int idx_ij = 0
 *     cdef int idx_ik = 0             # <<<<<<<<<<<<<<
 *     cdef int idx_kj = 0
 ...
 */
  ...
  /* "computations1/computations.pyx":15
 *     cdef int idx_ij = 0
 *     cdef int idx_ik = 0
 *     cdef int idx_kj = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "computations1/computations.pyx":17
 *     cdef int idx_kj = 0
 * 
 *     for i in range(N):             # <<<<<<<<<<<<<<
 *         for k in range(N):
 ...
 */
  ...
  for (;;) {
    ...
    /* "computations1/computations.pyx":18
 * 
 *     for i in range(N):
 *         for k in range(N):             # <<<<<<<<<<<<<<
 *             idx_ik = N * i + k
 ...
 */
    ...
    for (;;) {
      ...
      /* "computations1/computations.pyx":19
 *     for i in range(N):
 *         for k in range(N):
 *             idx_ik = N * i + k             # <<<<<<<<<<<<<<
 *             for j in range(N):
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_8 = PyNumber_Multiply(__pyx_t_5, __pyx_v_i); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 19, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = PyNumber_Add(__pyx_t_8, __pyx_v_k); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 19, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
      __pyx_t_9 = __Pyx_PyInt_As_int(__pyx_t_5); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 19, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_v_idx_ik = __pyx_t_9;

      /* "computations1/computations.pyx":20
 *         for k in range(N):
 *             idx_ik = N * i + k
 *             for j in range(N):             # <<<<<<<<<<<<<<
 *                 idx_ij = N * i + j
 *                 idx_kj = N * k + j
 */
      __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_N); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 20, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_8 = __Pyx_PyObject_CallOneArg(__pyx_builtin_range, __pyx_t_5); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 20, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      if (likely(PyList_CheckExact(__pyx_t_8)) || PyTuple_CheckExact(__pyx_t_8)) {
        ...
        __pyx_t_10 = -1; __pyx_t_5 = PyObject_GetIter(__pyx_t_8); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 20, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
      ...
      for (;;) {
        if (likely(!__pyx_t_11)) {
          if (likely(PyList_CheckExact(__pyx_t_5))) {
            ...
            #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
            __pyx_t_8 = PyList_GET_ITEM(__pyx_t_5, __pyx_t_10); __Pyx_INCREF(__pyx_t_8); __pyx_t_10++; if (unlikely(0 < 0)) __PYX_ERR(0, 20, __pyx_L1_error)
            #else
            __pyx_t_8 = PySequence_ITEM(__pyx_t_5, __pyx_t_10); __pyx_t_10++; if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 20, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_8);
            #endif
          } else {
            if (__pyx_t_10 >= PyTuple_GET_SIZE(__pyx_t_5)) break;
            #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
            __pyx_t_8 = PyTuple_GET_ITEM(__pyx_t_5, __pyx_t_10); __Pyx_INCREF(__pyx_t_8); __pyx_t_10++; if (unlikely(0 < 0)) __PYX_ERR(0, 20, __pyx_L1_error)
            #else
            __pyx_t_8 = PySequence_ITEM(__pyx_t_5, __pyx_t_10); __pyx_t_10++; if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 20, __pyx_L1_error)
            __Pyx_GOTREF(__pyx_t_8);
            #endif
        ...
        /* "computations1/computations.pyx":21
 *             idx_ik = N * i + k
 *             for j in range(N):
 *                 idx_ij = N * i + j             # <<<<<<<<<<<<<<
 *                 idx_kj = N * k + j
 ...
 */
        __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v_N); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 21, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __pyx_t_12 = PyNumber_Multiply(__pyx_t_8, __pyx_v_i); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 21, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_8 = PyNumber_Add(__pyx_t_12, __pyx_v_j); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 21, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
        __pyx_t_9 = __Pyx_PyInt_As_int(__pyx_t_8); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_v_idx_ij = __pyx_t_9;

        /* "computations1/computations.pyx":22
 *             for j in range(N):
 *                 idx_ij = N * i + j
 *                 idx_kj = N * k + j             # <<<<<<<<<<<<<<
 *                 matrix_result[idx_ij] += (
 ...
 */
        __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v_N); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 22, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __pyx_t_12 = PyNumber_Multiply(__pyx_t_8, __pyx_v_k); if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 22, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_12);
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_t_8 = PyNumber_Add(__pyx_t_12, __pyx_v_j); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 22, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF(__pyx_t_12); __pyx_t_12 = 0;
        __pyx_t_9 = __Pyx_PyInt_As_int(__pyx_t_8); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 22, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
        __pyx_v_idx_kj = __pyx_t_9;

        /* "computations1/computations.pyx":24
 *                 idx_kj = N * k + j
 *                 matrix_result[idx_ij] += (
 *                     matrix1[idx_ik] * matrix2[idx_kj]             # <<<<<<<<<<<<<<
 *                 )
 */
        __pyx_t_13 = __pyx_v_idx_ik;
        __pyx_t_14 = __pyx_v_idx_kj;

        /* "computations1/computations.pyx":23
 *                 idx_ij = N * i + j
 *                 idx_kj = N * k + j
 *                 matrix_result[idx_ij] += (             # <<<<<<<<<<<<<<
 *                     matrix1[idx_ik] * matrix2[idx_kj]
 *                 )
 */
        __pyx_t_15 = __pyx_v_idx_ij;
        *((float *) ( /* dim=0 */ (__pyx_v_matrix_result.data + __pyx_t_15 * __pyx_v_matrix_result.strides[0]) )) += ((*((float *) ( /* dim=0 */ (__pyx_v_matrix1.data + __pyx_t_13 * __pyx_v_matrix1.strides[0]) ))) * (*((float *) ( /* dim=0 */ (__pyx_v_matrix2.data + __pyx_t_14 * __pyx_v_matrix2.strides[0]) ))));
 ...
 */
  ...
  __Pyx_WriteUnraisable("computations1.computations.matrixMultiply", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_13computations1_12computations_1matrixMultiply(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_13computations1_12computations_1matrixMultiply(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_matrix1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_matrix2 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_matrix_result = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_N;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_matrix1,&__pyx_n_s_matrix2,&__pyx_n_s_matrix_result,&__pyx_n_s_N,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_matrix2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("matrixMultiply", 1, 4, 4, 1); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_matrix_result)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("matrixMultiply", 1, 4, 4, 2); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_N)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("matrixMultiply", 1, 4, 4, 3); __PYX_ERR(0, 7, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "matrixMultiply") < 0)) __PYX_ERR(0, 7, __pyx_L3_error)
      }
    ...
    __pyx_v_matrix1 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_matrix1.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_matrix2 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_matrix2.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_matrix_result = __Pyx_PyObject_to_MemoryviewSlice_ds_float(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_matrix_result.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_N = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_N == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 11, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("matrixMultiply", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 7, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("computations1.computations.matrixMultiply", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_13computations1_12computations_matrixMultiply(__pyx_self, __pyx_v_matrix1, __pyx_v_matrix2, __pyx_v_matrix_result, __pyx_v_N);
...
static PyObject *__pyx_pf_13computations1_12computations_matrixMultiply(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_matrix1, __Pyx_memviewslice __pyx_v_matrix2, __Pyx_memviewslice __pyx_v_matrix_result, int __pyx_v_N) {
  ...
  __pyx_t_1 = __Pyx_void_to_None(__pyx_f_13computations1_12computations_matrixMultiply(__pyx_v_matrix1, __pyx_v_matrix2, __pyx_v_matrix_result, __pyx_v_N, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_matrix1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_matrix2, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_matrix_result, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "computations1.computations.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "computations1.computations.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "computations1.computations.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "computations1.computations._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"matrixMultiply", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_13computations1_12computations_1matrixMultiply, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_computations1__computations) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "computations1.computations")) {
      if (unlikely(PyDict_SetItemString(modules, "computations1.computations", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "computations1/computations.pyx":1
 * cimport cython             # <<<<<<<<<<<<<<
 * 
 * 
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init computations1.computations", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init computations1.computations");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
